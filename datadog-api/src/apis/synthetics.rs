use crate::{
    ...
    models::{
        SyntheticsLocationsResponse, SyntheticsTestCreateRequest, SyntheticsTestResponse,
        SyntheticsTestsResponse, SyntheticsTriggerRequest, SyntheticsTriggerResponse,
