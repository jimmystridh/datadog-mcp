...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
pub struct SearchMonitorsInput {
    #[schemars(description = "Search query (same as Datadog monitor manage page query parameter)")]
    pub query: String,
    #[schemars(description = "Page number to start from")]
    pub page: Option<i64>,
    #[schemars(description = "Number of monitors to return per page")]
    pub per_page: Option<i64>,
    #[schemars(description = "Sort order, e.g. 'name,asc' or 'status,desc'")]
...
pub struct CreateEventInput {
    ...
    pub title: String,
    #[schemars(description = "Event text/body")]
    pub text: String,
    #[schemars(description = "Optional tags")]
    pub tags: Option<Vec<String>>,
    #[schemars(description = "Optional alert type (error, warning, info, success, etc.)")]
    pub alert_type: Option<String>,
    #[schemars(description = "Optional priority (normal or low)")]
    pub priority: Option<String>,
    #[schemars(description = "Optional host name")]
    pub host: Option<String>,
    #[schemars(description = "Optional source type name")]
    pub source_type_name: Option<String>,
    #[schemars(description = "Optional aggregation key")]
    pub aggregation_key: Option<String>,
    #[schemars(description = "Optional POSIX timestamp (seconds)")]
    pub date_happened: Option<i64>,
    #[schemars(description = "Optional device name")]
    pub device_name: Option<String>,
    #[schemars(description = "Optional related event ID")]
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
pub struct DeleteSyntheticsTestsInput {
    #[schemars(description = "List of Synthetics test public IDs to delete")]
    pub test_ids: Vec<SyntheticsTestId>,
    #[schemars(description = "Delete the tests even if referenced by other resources")]
